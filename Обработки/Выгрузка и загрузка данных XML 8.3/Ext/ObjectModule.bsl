...
Процедура ВыполнитьЗагрузку(Знач ИмяФайла) Экспорт
	...
	// + IBS Шатунов А.С. 02/10/2018
	Если ИспользоватьПодменуОрганизаций Тогда
		
		ПодменитьОрганизации(ИмяФайла,ОрганизацияНовая,ОрганизацияЭталон);
		ПодменитьОрганизации(ИмяФайла,ОрганизацияСтарая,ОрганизацияНовая);
...
Процедура ПодменитьОрганизации(ИмяФайла,ОрганизацияЗаменяемая,ОрганизацияЗаменяющая);
	...
	Пока Строка <> Неопределено Цикл
		...
		ИД1 = ОрганизацияЗаменяемая.УникальныйИдентификатор();
		ИД2 = ОрганизацияЗаменяющая.УникальныйИдентификатор();
		
		ЗаписьТекста.ЗаписатьСтроку(СтрЗаменить(Строка,ИД1,ИД2));
