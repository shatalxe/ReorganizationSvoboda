...
&НаКлиенте
Процедура ОрганизацияЗаменяющаяПриИзменении(Элемент)
	ОтобразитьИдентификаторыОрганизаций();
КонецПроцедуры

&НаКлиенте
Процедура ОрганизацияЗаменяемаяПриИзменении(Элемент)
	ОтобразитьИдентификаторыОрганизаций();
КонецПроцедуры
...
Процедура ОтобразитьИдентификаторыОрганизаций()
	...
	Элементы.ОрганизацияЗаменяемаяИД.Заголовок = Объект.ОрганизацияЗаменяемая.УникальныйИдентификатор();
	Элементы.ОрганизацияЗаменяющаяИД.Заголовок = Объект.ОрганизацияЗаменяющая.УникальныйИдентификатор();
